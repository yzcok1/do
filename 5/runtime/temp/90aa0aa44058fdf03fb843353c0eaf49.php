...
<form action="<?php echo url('site/save'); ?>" method="post">
	...
	<div class="form-group" >
	<label>网站描述</label> 
	<textarea id="editor"  class="form-control" placeholder="文章内容" id="content" name="content" style="min-height: 100px;"><?php echo htmlentities($siteInfo['content']); ?></textarea>                   
	</div>
