...
<!-- 头部结束-->
	...
	<div class="row">
		...
		<div>			
            <a href="<?php echo url('detail',['id'=>$art['id']]); ?>"><img class="img-rounded" src="/static/image/<?php echo $art['title_img']; ?>"
            style="margin-right: 10px;float: left;width: 100px;height: 85px"/></a>
            <div class="content-detail" style="float: left;width: 80%">
              <!-- 获取当前文章的id -->
             <h4><a href="<?php echo url('detail',['id'=>$art['id']]); ?>"><?php echo $art['title']; ?></a></h4>
                <p>作者:<?php echo getUserName($art['user_id']); ?>&nbsp;&nbsp;
               发布时间：<?php echo getDateTime($art['create_time']); ?>&nbsp;&nbsp;
			   浏览:<?php echo $art['pv']; ?>&nbsp;&nbsp;
			   评论:<?php echo getCommentNum($art['id']); ?>&nbsp;&nbsp;
			   id:<?php echo $art['id']; ?>
               </p>
			  
				<h6 style='padding:0px 20px 0px 20px;color:#777777;'><?php echo getArticle($art['content']); ?></h6>	   
