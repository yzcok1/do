...
<table class="table table-striped table-hover text-center">
	...
	<tr>
		...
		<!-- 非当前用户是不允许编辑其它用户资料的 -->
		<?php if($user['id'] == \think\Session::get('user_id')): ?>
