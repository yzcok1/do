<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\myphp_www\PHPTutorial\WWW\5\public/../application/admin\view\site\index.html";i:1531356615;s:72:"D:\myphp_www\PHPTutorial\WWW\5\application\admin\view\public\layout.html";i:1531356615;s:72:"D:\myphp_www\PHPTutorial\WWW\5\application\admin\view\public\header.html";i:1531356615;s:69:"D:\myphp_www\PHPTutorial\WWW\5\application\admin\view\public\nav.html";i:1531356615;s:70:"D:\myphp_www\PHPTutorial\WWW\5\application\admin\view\public\left.html";i:1531356615;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo url('index/index'); ?>"><?php echo (isset($title) && ($title !== '')?$title:"后台管理"); ?></a>
    </div>
      ...
      <li><a href="<?php echo url('user/logout'); ?>">退出登录</a></li>
		...
		<div class="row">
			<div class="col-md-2 text-center">
				...
				<!-- 左侧4列 -->
<!-- 非超级管理员是不允许进行系统管理操作的 -->
<?php if(\think\Session::get('is_admin') == '1'): ?>
...
<form action="<?php echo url('site/save'); ?>" method="post">
	<!-- 用隐藏域向服务器传idd -->
	<input type="hidden" name="id" value="<?php echo $siteInfo['id']; ?>">

	<div class="form-group">
	    <label for="title">网站名称</label>
	    <input type="text" name="title" class="form-control" id="title" value="<?php echo $siteInfo['title']; ?>">
	</div>

	<div class="form-group">
	    <label for="keywords">关键字:</label>
	    <input type="text" name="keywords" class="form-control" id="keywords" value="<?php echo $siteInfo['keywords']; ?>">
	</div>

	<div class="form-group" >
	<label>网站描述</label> 
	<textarea id="editor"  class="form-control" placeholder="文章内容" id="content" name="content" style="min-height: 100px;"><?php echo $siteInfo['desc']; ?></textarea>                   
	</div>
