<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\myphp_www\PHPTutorial\WWW\tp5\public/../application/index\view\index\index.html";i:1529455175;s:74:"D:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\common\header.html";i:1529455175;s:72:"D:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\common\foot.html";i:1529455175;}*/ ?>
	...
	<div class="container">
		<div class="content">
			<div class="col-md-7 content-left">
				...
				<div class="article">
					<h6>Printers</h6>
					<a class="title" href="<?php echo url('index/single/single'); ?>">Nokia offering customers printable STL phone cases for the Lumia 820 and things </a>
					<a href="<?php echo url('index/single/single'); ?>"><img src="http://127.0.0.1/tp5/public/static/index/images/a2.jpg" alt="" /></a>
			...
			<div class="content-right-top">
				...
				<a href="<?php echo url('index/single/single'); ?>">
				...
				<a class="active" href="<?php echo url('index/single/single'); ?>">
					<div class="editor text-center">
				...
				<div class="editors-pic-grids">
					...
					<div class="editors-pic">
						<div class="e-pic">
							<a href="<?php echo url('index/single/single'); ?>"><img src="http://127.0.0.1/tp5/public/static/index/images/ep1.jpg" alt="" /></a>
						</div>
						<div class="e-pic-info">
							<a href="<?php echo url('index/single/single'); ?>">MarkerBot Announces the ‘Replicator 2x’  For the Experimental</a>
							<span></span>
							<label>2 Days Ago</label>
						</div>
						<div class="clearfix"></div>
					...
					<div class="editors-pic">
						<div class="e-pic">
							<a href="<?php echo url('index/single/single'); ?>"><img src="http://127.0.0.1/tp5/public/static/index/images/ep2.jpg" alt="" /></a>
						</div>
						<div class="e-pic-info">
							<a href="<?php echo url('index/single/single'); ?>">3D Printed Record – the next revolution?</a>
							<span></span>
							<label>2 Days Ago</label>
						</div>
						<div class="clearfix"></div>
					...
					<div class="editors-pic">
						<div class="e-pic">
							<a href="<?php echo url('index/single/single'); ?>"><img src="http://127.0.0.1/tp5/public/static/index/images/ep3.jpg" alt="" /></a>
						</div>
						<div class="e-pic-info">
							<a href="<?php echo url('index/single/single'); ?>">MarkerBot Announces the ‘Replicator 2x’  For the Experimental</a>
							<span></span>
					...
					<div class="editors-pic">
						<div class="e-pic">
							<a href="<?php echo url("","",true,false);?>"><img src="http://127.0.0.1/tp5/public/static/index/images/ep4.jpg" alt="" /></a>
						</div>
						<div class="e-pic-info">
							<a href="<?php echo url('index/single/single'); ?>">3D Printed Record – the next revolution?</a>
							<span></span>
